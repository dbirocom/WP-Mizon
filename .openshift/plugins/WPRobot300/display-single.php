...
<p>Next autopost will be created on <?php echo date('m/j/Y H:i:s',wp_next_scheduled("wprobothook",array($result->id)));?><i> (every <?php echo $result->cinterval." ".$result->period; ?>).</i></p>
<?php } else { ?>
...
<?php $i=1;foreach ($templates as $num => $template) { ?>
	...
	<b><?php _e("Template","wprobot") ?> <?php echo $i; ?></b><br/>
