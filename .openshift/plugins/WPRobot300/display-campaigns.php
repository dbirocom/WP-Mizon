...
-->
	...
	<div class="updated" style="margin-top: 60px;">
		<div style="float:left;margin-right:15px;">		
			<h3 style="margin: 10px 0 0 0;">Quick Links</h3>
			<p><a target="_blank" href="http://wprobot.net/">WP Robot</a> | <a target="_blank" href="http://wprobot.net/documentation">Documentation</a> | <a target="_blank" href="http://wprobot.net/forum">Support</a> | <a target="_blank" href="http://wprobot.net/robotpal/sendnew.php">New Download</a></p>
		</div>	
		<div style="float:left;">
			<h3 style="margin: 10px 0 0 0;">Other Services</h3>
	...
	<div class="updated" style="margin-top: 20px;">
		<h3 style="margin: 10px 0 0 0;">License Information</h3>
