...
<?php } ?>
		...
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 		
			<tr valign="top"> 
				...
				<select name="wpr_poststatus" id="wpr_poststatus">
					<option <?php if ($options['wpr_poststatus']=='published') {echo 'selected';} ?>><?php _e("published","wprobot") ?></option>
					<option <?php if ($options['wpr_poststatus']=='draft') {echo 'selected';} ?>><?php _e("draft","wprobot") ?></option>
				</select>
				</td> 
			</tr>	
			<tr valign="top"> 
				...
				<select name="wpr_resetcount" id="wpr_resetcount">
					<option <?php if ($options['wpr_resetcount']=='no') {echo 'selected';} ?>><?php _e("no","wprobot") ?></option>
			...
			<tr valign="top"> 
				...
				<td><?php _e("Post as User ID","wprobot") ?> <input id="wpr_authorid" size="7" class="small-text" type="text" value="<?php echo $options['wpr_authorid']; ?>" name="wpr_authorid"/></td> 
			</tr>	
			<tr valign="top"> 
	...
	<p><i>Important: Only edit the options below if you know what you are doing!</i></p>
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 		
			<tr valign="top"> 
	...
	<div class="updated" style="margin-top: 20px;">	
		<h3>Unix Cron Job</h3>
		<p>You can set up an Unix cron job in your servers control panel as an alternative to the Wordpress pseodo-cron jobs. See the <a href="http://wprobot.net/test/documentation/#412">documentation</a> for details. Use the following URL for your cron job:<br/><i><?php echo WPR_URLPATH ."cron.php?code=".get_option("wpr_cron"); ?></i>
		</p>
	</div>	
